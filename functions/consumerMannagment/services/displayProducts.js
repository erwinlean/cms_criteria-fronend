        ...
        data.forEach((product) => {
            ...
            for (const attributeName in product.values) {
                if (product.values.hasOwnProperty(attributeName)) {
                    ...
                    if ((lowerAttributeName.includes("image") || lowerAttributeName.includes("img")) && (lowerAttributeValue.endsWith(".png") || lowerAttributeValue.endsWith(".jpg") || lowerAttributeValue.endsWith(".jpeg"))) {
